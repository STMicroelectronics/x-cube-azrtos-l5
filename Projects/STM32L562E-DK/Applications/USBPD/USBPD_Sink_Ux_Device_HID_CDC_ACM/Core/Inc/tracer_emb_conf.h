...
#define TRACER_EMB_TX_GPIO_ENABLE_CLOCK()            LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOG)
#define TRACER_EMB_RX_GPIO                           GPIOG
#define TRACER_EMB_RX_PIN                            LL_GPIO_PIN_8
#define TRACER_EMB_RX_AF                             LL_GPIO_AF_8
#define TRACER_EMB_RX_GPIO_ENABLE_CLOCK()            LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOG)
...
#define TRACER_EMB_SET_CLK_SOURCE_USART()            /* No need for clock source selection in case of USARTLPUART1 */
