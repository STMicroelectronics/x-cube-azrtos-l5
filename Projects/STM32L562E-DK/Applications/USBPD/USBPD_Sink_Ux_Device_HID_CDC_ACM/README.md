...
When plugged to PC host, the STM32L562xx must be properly enumerated a composite device as an HID ,USB Serial device and an STlink Com port.
...
RTOS, ThreadX, USBX, USBXDevice, USB_DRD, Full Speed, CDC, HID, VCP, USART, DMA, Mouse, USBPD SINK Type-C.

### <b>Hardware and Software environment</b>

  - This application runs on STM32L562xx devices
  - This application has been tested with STMicroelectronics STM32L562E-DK boards Revision MB1581-B01.
