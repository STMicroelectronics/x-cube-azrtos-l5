...
#define LX_STM32_OSPI_POST_INIT()                        do { \
                                                         if (tx_semaphore_create(&ospi_rx_semaphore, "ospi rx transfer semaphore", 1) != TX_SUCCESS) \
                                                         { \
                                                           return LX_ERROR; \
                                                         } \
                                                         if (tx_semaphore_create(&ospi_tx_semaphore, "ospi tx transfer semaphore", 1) != TX_SUCCESS) \
                                                         { \
                                                           return LX_ERROR; \
                                                         } \
                                                        } while(0)
...
#define LX_STM32_OSPI_PRE_READ_TRANSFER(__status__)     do { \
...
#define LX_STM32_OSPI_POST_READ_TRANSFER(__status__)    do { \
                                                          if(tx_semaphore_put(&ospi_rx_semaphore) != TX_SUCCESS) \
                                                          { \
                                                            __status__ = LX_ERROR; \
                                                          } \
                                                        } while(0)
...
#define LX_STM32_OSPI_READ_TRANSFER_ERROR(__status__)   do { \
...
#define LX_STM32_OSPI_PRE_WRITE_TRANSFER(__status__)    do { \
...
#define LX_STM32_OSPI_POST_WRITE_TRANSFER(__status__)   do { \
                                                          if(tx_semaphore_put(&ospi_tx_semaphore) != TX_SUCCESS) \
                                                          { \
                                                            __status__ = LX_ERROR; \
                                                          } \
                                                        } while(0)
...
#define LX_STM32_OSPI_WRITE_TRANSFER_ERROR(__status__)  do { \
