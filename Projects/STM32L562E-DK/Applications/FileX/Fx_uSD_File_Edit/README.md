...
This application provides an example of Azure RTOS FileX stack usage on STM32L562E-DK, it shows how to develop a basic SD card file
...
- A blinking LED_GREEN light marks the success of the file operations.
