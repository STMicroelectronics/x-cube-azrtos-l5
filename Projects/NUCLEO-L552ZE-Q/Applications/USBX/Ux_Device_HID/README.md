...
This application provides an example of Azure RTOS USBX stack usage on NUCLEO-L552ZE-Q board,
...
When plugged to PC host, the NUCLEO-L552ZE-Q must be properly enumerated as an USB HID mouse device.
During the enumeration phase, device provides host with the requested descriptors (Device, configuration, string).
Those descriptors are used by host driver to identify the device capabilities.
Once the NUCLEO-L552ZE-Q USB device successfully completed the enumeration phase, the device sends a HID report after a user button press.
...
RTOS, ThreadX, USBX_Device, USBX, Full Speed, HID, Mouse
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-L552ZE-Q board Set-up
    -Connect the NUCLEO-L552ZE-Q board CN1 to the PC through "TYPE-C" to "Standard A" cable.
